Shader "Hidden/Locked/.poiyomi/Poiyomi 8.2/Poiyomi Pro Geometric Dissolve/446ed889f19ce2242b66ebd26619bffe"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				float2 matcapUV = 0;
				#ifdef POI_MATCAP0
				float3 normal0 = poiMesh.normals[(0.0 /*_MatcapNormal*/)];
				...
				matcapUV = lerp(matcapUV, poiMesh.uv[(0.0 /*_MatcapUVToBlend*/)], float4(0,0,0,0).xy);
				...
				{
					matcap.rgb = hueShift(matcap.rgb, (0.0 /*_MatcapHueShift*/) + _Time.x * (10.0 /*_MatcapHueShiftSpeed*/));
				}
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (1.0 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.2 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/));
				#endif
				#ifdef COLOR_GRADING_HDR_3D
			...
			{
				float2 st = frac(poiMesh.uv[(0.0 /*_GlitterUV*/)] + float4(0,0.1,0,0).xy * _Time.x) * (300.0 /*_GlitterFrequency*/);

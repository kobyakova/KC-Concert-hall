Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi World/c54db4a358c75b841b7393f2bd2f7c4b"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyAudioLinkDecal(in PoiMesh poiMesh, inout PoiFragData poiFragData, in PoiMods poiMods)
			{
				...
				if ((0.0 /*_ALDecalShapeClip*/))
				{
					...
					float bandwidth = (1.0 /*_ALDecalUVMode*/) == 1 ? (0.5 /*_ALDecalShapeClipBandWidth*/) / aluv.y : (0.5 /*_ALDecalShapeClipBandWidth*/);
				...
				float audioVal = audioTexture.b * (1.66 /*_ALDecalVolume*/) * lerp((5.0 /*_ALDecalBaseBoost*/), (1.0 /*_ALDecalTrebleBoost*/), audioLinkMask.g);
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				#if defined(PROP_EMISSIONMASK) || !defined(OPTIMIZER_ENABLED)
				float emissionMask0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMaskUV*/)], float4(5,5,0,0)) + _Time.x * float4(1,1,0,0))[(0.0 /*_EmissionMaskChannel*/)];
				#else
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,1,1,0.3137255).rgb, (0.0 /*_ColorThemeIndex*/));
